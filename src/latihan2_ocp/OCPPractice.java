...
public class OCPPractice {
    public static void main(String[] args) {
        ...
        System.out.println("X Harus modify method sendNotification()");
        System.out.println("X Harus tambah else if baru");
        System.out.println("X Risk merusak existing functionality");
        System.out.println("X Setiap channel baru = modify existing code");
